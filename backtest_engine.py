# backtest_engine.py - FULLY CORRECTED
import pandas as pd
import numpy as np
...
class BacktestEngine:
    ...
    def fetch_data(self, symbol: str, days: int = 7) -> pd.DataFrame:
        """Φέρνει ΠΡΑΓΜΑΤΙΚΑ δεδομένα από Binance"""
        ...
        try:
            ...
            if isinstance(data, dict) and 'code' in data:
                if data['code'] == -1121:
                    ...
                    raise ValueError(f"Futures API error: {data}")
            else:
    ...
    def run_backtest(self, symbol: str) -> Dict:
        ...
        for idx, row in df.iterrows():
            ...
            # 1. EXITS (Buick: κλείνει όλες μαζί στο 2%)
            ...
            # 2. ENTRIES (Buick: ανοίγει σε 0.1% πτώση)
            ...
            # 3. RESET CAPITAL (Buick: όταν φτάσει $600+)
            strategy.reset_capital_if_needed()
            
            # 4. EMERGENCY CHECK (Buick: αντέχει -30%)
